...
<div class="wrap J_check_wrap">
  <div class="nav">
    <ul class="cc">
        ...
        <li  class="current"><a href="javascript:void()" >编辑公告</a></li>
      </ul>
</div>
  <form name="myform" action="{:U('Homeannouce/annouce_edit')}" method="post" class="J_ajaxForm">
  ...
  <table width="100%" class="table_form">
		...
		<tr>
			...
			<input type="text" name="title"  class="input" id="name" value="{$one.title}"/></td>
		</tr>

		<tr class="upfileBox">
			<th width="120">详情</th> 
			<td><span class="must_red">*</span><div id='content_tip'></div><script type="text/plain" id="content" name="content">{$one.content}</script>
