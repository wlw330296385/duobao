      ...
      <table width="100%" cellspacing="0">
        <thead>
          <tr>
            ...
            <td align="left">徒弟</td>
            <td align="left">徒孙</td>
            <td align="left">消费记录</td>
            <td align="left">最后登录</td>
            <td align="left">充值总额</td>
        ...
        <tbody>
          <volist name="data" id="vo">
            <tr>
              ...
              <td align="left"><img src="{$vo['userpic']}" height=18 width=18 onerror="this.src='{$config_siteurl}statics/images/member/nophoto.gif'"><a href="{:U('Member/statistics_user',array('id'=>$vo['userid']))}">{$vo.username}</a><a href="javascript:member_infomation({$vo.userid}, '{$vo.modelid}', '')"><img src="{$config_siteurl}statics/images/icon/detail.png"></a></td>
              <td align="left">{$vo.nickname}</td>
              <td align="left">{$vo.email}</td>
              <td align="left">{$groupsModel[$vo['modelid']]}</td>
              <td align="left">{$vo.regip}</td>
              <td align="left"><?php echo date('Y-m-d h:i',$vo['regdate']) ?></td>
              <td align="left"><a href="{:U('Member/index', array(show=>'child',ids=>$vo['child_id']) )}">{$vo.childNum}</a></td>
              <td align="left"><a href="{:U('Member/index', array(show=>'grandson',ids=>$vo['grandson_id']) )}">{$vo.grandsonNum}</a></td>
              <td align="left"><a href="{:U('Member/shopRecord',array('userid'=>$vo['userid'],'username'=>$vo['username']))}">查看详情</a></td>
              ...
              <td align="left"><a href="{:U('Member/records', array('userid'=>$vo['userid']) )}">[充值记录]</a>
